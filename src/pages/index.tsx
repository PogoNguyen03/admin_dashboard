          ...
          <div className="page-content">
            <div className="container-fluid">
              <div className="row">
                            ...
                            <form action="javascript:void(0);">
                              <div className="row g-3 mb-0 align-items-center">
                                ...
                                <div className="col-auto">
                                  <button
                                    type="button"
                                    className="btn btn-soft-success btn-icon waves-effect waves-light layout-rightside-btn"
                                  >
                            ...
                            <div className="d-flex align-items-end justify-content-between mt-4">
                              ...
                              <div className="avatar-sm flex-shrink-0">
                                <span className="avatar-title bg-secondary-subtle rounded fs-3">
                                  <i className="bx bx-dollar-circle text-secondary" />
                                </span>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="d-flex align-items-end justify-content-between mt-4">
                              ...
                              <div className="avatar-sm flex-shrink-0">
                                <span className="avatar-title bg-primary-subtle rounded fs-3">
                                  <i className="bx bx-shopping-bag text-primary" />
                                </span>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="d-flex align-items-end justify-content-between mt-4">
                              ...
                              <div className="avatar-sm flex-shrink-0">
                                <span className="avatar-title bg-warning-subtle rounded fs-3">
                                  <i className="bx bx-wallet text-warning" />
                                </span>
                              </div>
                            </div>
                          </div>
                ...
                {/* end col */}
                <div className="col-auto layout-rightside-col d-none">
                        ...
                        <div className="p-3 mt-2">
                          ...
                          <ol className="ps-3 text-muted">
                            ...
                            <li className="py-1">
                              <a href="#" className="text-muted">
                                Desktop{" "}
                                <span className="float-end">(6,256)</span>
                              </a>
                            </li>
                            <li className="py-1">
                              <a href="#" className="text-muted">
                            ...
                            <li className="py-1">
                              <a href="#" className="text-muted">
                                Grocery{" "}
                                <span className="float-end">(1,950)</span>
                              </a>
                            </li>
                            <li className="py-1">
                              <a href="#" className="text-muted">
                                Fashion{" "}
                                <span className="float-end">(1,582)</span>
                              </a>
                            </li>
                            <li className="py-1">
                              <a href="#" className="text-muted">
